                ...
                <Col md={8}>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            {order.isDelivered ? (<Messages variant='success'>Delivered on {order.deliveredAt}</Messages>) : (<Messages variant='danger'>
                                Not Delivered
                                </Messages>)}
                        </ListGroup.Item>
                        ...
                        <ListGroup.Item>
                            ...
                            {order.isPaid ? (<Messages variant='success'>Paid on {order.paidAt}</Messages>) : (<Messages variant='danger'>
                                Not Paid
                                </Messages>)}
                        </ListGroup.Item>
                        ...
                        <ListGroup.Item>
                            <h2>Order Items</h2>
                            {order.orderItems.length ===0 ? <Messages>You cart is empty</Messages> : (
                                <ListGroup variant='flush'>
